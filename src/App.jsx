...
export default function App() {
    ...
    const weeksSinceStart = Math.floor(
        (Date.now() - CHALLENGE_START.getTime()) / msPerWeek,
    );
    const currentWeek =
        weeksSinceStart >= 0 && weeksSinceStart < BOOSTERS.length
            ? weeksSinceStart
            : -1;
        ...
        <div className="wrap">
            <header className="hero">
                ...
                <div className="sub">
                    ...
                    <span className="gold">22 Jun – 27 Sep 2026</span> · Cash
                    prizes up to RM5,000
                </div>
            </header>
            ...
            <section className="legend">
                ...
                <ul>
                    <li>
                        <b>The 3 cards up top happen every single week</b> —
                        weigh-in (Mon), step log, and 3 workouts.
                    </li>
                    <li>
                        <b>The booster changes every 2 weeks.</b> Just check
                        your week's row for what's special.
                    </li>
                    <li>
                        <b>Booster pts = 30 / 40:</b>{" "}
                        <span className="req">30</span> = Lark Base submission
                        (required for any points).{" "}
                        <span className="opt">40</span> = Lark Base <i>+</i>{" "}
                        post on ZUS Moments with the hashtags.
                    </li>
                    <li>
                        <b>Wk target = {WEEK_MAX}:</b> the realistic ceiling —
                        100 steps + 100 workouts + 40 booster.{" "}
                        <b>Weigh-in is excluded</b> (you can't bank the 40-pt
                        loss tier every week). Bi-weekly max is{" "}
                        <b>{fmt(BIWEEKLY_MAX)}</b>; <b>Acc. total</b> is the
                        running cumulative max, ending at{" "}
                        <b>{fmt(WEEK_MAX * BOOSTERS.length)}</b> — your
                        leaderboard benchmark.
                    </li>
                    <li>
                        <b>All submissions go to the Lark Base Tracker</b> —
                        that's mandatory for points to count.
                    </li>
                    <li>
                        All activities must be done <b>outside working hours</b>
                        . Only weight <i>losses</i> earn points (maintain/gain =
                        0).
                    </li>
                    <li>
                        <b>Final report: 28 Sep</b> — the day after W14 closes;
                        final standings are tallied then.
                    </li>
                </ul>
            </section>
        </div>
